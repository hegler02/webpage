"""Verify Harugyeol introduction identity, context and share-image delivery."""
from pathlib import Path
import tempfile,shutil,sys,json
from render_harugyeol_intro import render
R=Path(__file__).resolve().parents[1];P=R/'pages/profile';D=P/'archive/harugyeol-ai-health'
...
assert (D/'index.html').read_text()==render(),'Harugyeol introduction output drift'
...
print('Harugyeol discovery and viewing gate: PASS')
