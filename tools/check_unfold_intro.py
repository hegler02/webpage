...
from render_unfold_intro import render, DESTINATION, BODY_ID
...
assert source == render(), 'Unfold introduction differs from its content authority'
page = Document()
page.feed(source)
...
for relative in ('archive/image-cinema/index.html', 'archive/already-autumn/index.html', 'archive/tuna-man/index.html'):
    parsed = Document()
...
with tempfile.TemporaryDirectory() as tmp:
    ...
    assert not errors, '\n'.join(errors)
print('Unfold introduction, reciprocal links and discovery: PASS')
