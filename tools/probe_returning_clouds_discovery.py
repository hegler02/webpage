...
ROOT=Path(__file__).resolve().parents[1];PROFILE=ROOT/'pages/profile';PAGE=PROFILE/'archive/baekun-five-strike-action-cinema'
...
assert {'source':'/archive/baekun-five-strike-action-cinema/','destination':'/pages/profile/archive/baekun-five-strike-action-cinema/'} in config['rewrites']
with tempfile.TemporaryDirectory() as tmp:
 ...
 print('Hwasan Returning Clouds introduction SEO, OG, Twitter, JSON-LD and image: PASS')
