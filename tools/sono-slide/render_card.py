...
def render(w,h,path):
 ...
 text(60,96,'MIRINAEMAN / MUSIC',19,color('accent'))
 text(56,181,'나의 이야기를,',74,color('paper'));text(56,280,'나의 노래로.',88,color('accent'))
 text(60,415,'Suno로 원하는 노래 만들기',31,color('paper'))
 text(60,533,'김준호 · 미리내맨',22,color('muted'));text(949,533,'17 SLIDES',21,color('muted'))
